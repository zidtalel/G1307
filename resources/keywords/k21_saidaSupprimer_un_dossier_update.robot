...
Supprimer un dossier
    ...
    Click Element    ${btn_Supprimer}
     # Vérifier que le dossier a été supprimé avec succès en vérifiant l'absence du dossier sur la page
    Page Should Not Contain Element    ${link_NomDossier1}${vNomDossier}${link_NomDossier2}
